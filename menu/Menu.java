...
import rac.menu.mode.LightDarkMode;
...
import rac.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Panel de Control"},
        {"~USUARIOS~"},
        {"Gestión de Usuarios", "Mostrar usuarios", "Filtrar usuarios"},
        //CAPITULO 2
        {"~REPORTE~"},
        {"Historial de acceso", "Filtrar fechas"},
        //CAPITULO 3
        {"~ADMINISTRADOR~"},
        {"Manipulación de datos", "Registrar usuario","Eliminar usuario", "Modificar usuario"},
        {"Registrar acceso RFID"},
        {"Información adicional", "Manual de uso", "Contáctanos"},
        {"Base de datos","Conectar/Desconectar base de datos"},
        {"Logout"}
    };
    ...
    private final String headerName = "RAC Tablero";

    protected final boolean hideMenuTitleOnMinimum = true;
    protected final int menuTitleLeftInset = 5;
    protected final int menuTitleVgap = 5;
    protected final int menuMaxWidth = 250;
    protected final int menuMinWidth = 80;
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/rac/icon/png/logo-rac.png")));
